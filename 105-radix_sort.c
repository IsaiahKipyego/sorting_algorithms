...
/**
 * get_max - fetches maximum value in array
 * @array: to get the max value
 * @size: of the array
 *
 * Return: maximum value in array of numbers
 */
...
/**
 * count_sort - count sort method to sort each place value
 * @array: to sort
 * @size: of the array
 * @exp: exponential value
 * @out: a temp array to store copy of values
 */
...
/**
 * radix_sort - radix sort algorithm sorts array
 * @array: to be sorted
