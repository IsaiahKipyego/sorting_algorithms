 ...
 * @item1: element one in array
 * @item2: element two in array
 * @order: ascending order 1, descending order 0
 */
...
/**
 * merge - sort bitonic sequences recursively in ascendin n descendig
 * @arr: array to be sorted
 * @low: first element of array
 * @nelemnt: number of elements in array
 * @order: ascending order 1, 0 descending order 0
 */
 ...
 * @order: ascending 1, descending 0
 * @size: of array
 */
